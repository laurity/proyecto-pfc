      ...
      <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
        <div class="flex flex-wrap mb-24 -mx-3">
          <div class="w-full pr-2 lg:w-1/4 lg:block">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              <h2 class="text-2xl font-bold dark:text-gray-400">Otras categorías</h2>
              <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
              <ul>
                <li class="mb-4">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              ...
              <div>
                ...
                <input type="range" wire:model.live="price_range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" min="1" max="790" value="0.5" step="0.5">
                <div class="flex justify-between ">
                  <span class="inline-block text-lg font-bold text-blue-400 ">{{ number_format(1, 2, ',', '') . ' €' }}</span>
                  <span class="inline-block text-lg font-bold text-blue-400 ">{{ number_format(790, 2, ',', '') . ' €' }} </span>
                </div>
              </div>
            </div>
          </div>
          <div class="w-full px-3 lg:w-3/4">
            ...
            <div class="flex flex-wrap items-center ">
              ...
              <div class="p-3 ">
                ...
                <p class="text-lg ">
                  <span class="text-green-600 dark:text-green-600">{{ number_format($product->price, 2, ',', '') . ' €' }}</span>
                </p>
              </div>
              <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                ...
                <a wire:click.prevent='addToCart({{ $product->id}})' href="#" class="text-gray-500 flex items-center space-x-2 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-300">
                  ...
                  </svg><span wire:loading.remove wire:target='addToCart({{ $product->id}})'>Añadir al carrito</span><span wire:loading wire:target='addToCart({{ $product->id}})'>Añadiendo...</span>
                </a>
              </div>
            </div>
          </div>
