<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto min-h-screen mt-16">
  <div class="container mx-auto px-4pt-12 ">
    <h1 class="mt-16 text-3xl font-bold mb-6 text-center text-black-">Carrito de Compras</h1>
    <div class="flex flex-col lg:flex-row gap-6">
      <div class="w-full lg:w-3/4">
        <div class="bg-white rounded-lg shadow-lg p-4 sm:p-8 mb-6 overflow-hidden">
