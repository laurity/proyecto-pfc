		...
		<div class="grid grid-cols-12 gap-4">
					...
					<div class="mb-6">
						...
						<div class="grid grid-cols-2 gap-4 mt-4">
							...
							<div>
								...
								<input wire:model='postal_code' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('postal_code') border-red-500 @enderror" id="zip" type="text">
								</input>
								@error('postal_code')
			...
			<div class="md:col-span-12 lg:col-span-4 col-span-12">
				...
				<button type="submit" class="bg-green-500 mt-4 w-full p-3 rounded-lg text-lg text-white hover:bg-green-600">
					<span wire:loading.remove>placeOrder</span>
						...
						<li class="py-3 sm:py-4" wire:key=' {{ $ci['product_id'] }}'>
							<div class="flex items-center">
								<div class="flex-shrink-0">
									<img alt="Neil image" class="w-12 h-12 rounded-full" src="{{ url('storage', $ci['image'])}}">
									</img>
								</div>
