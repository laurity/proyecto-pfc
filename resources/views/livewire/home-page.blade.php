  ...
  <div>
    ...
    <section id="presentacion" style="background: url('{{ asset('storage/nosotros.jpg') }}') center/cover; height: 100vh;">
      <div class="flex items-center justify-center h-full bg-black bg-opacity-60">
        <div class="text-center text-white p-4">
          <h1 class="text-6xl font-bold mb-4">Alonso del Rey Estilistas</h1>
          <p class="text-2xl">Transformamos tu look, realzamos tu belleza</p>
        </div>
      </div>
    </section>
    ...
    <section id="servicios" class="py-20 bg-orange-100">
      <div class="container mx-auto px-8">
        <h2 class="text-4xl font-bold text-center text-black mb-10">Nuestros Servicios</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div class="bg-white p-10 rounded-lg shadow-xl transition transform hover:scale-105">
            ...
            <h3 class="text-2xl font-bold text-black mb-5">Corte de Pelo</h3>
            <p class="text-lg text-gray-700">Ofrecemos cortes de pelo modernos y clásicos para cualquiera que desee un cambio de look. Nuestro equipo se asegura de que salgas con el estilo que deseas.</p>
          </div>
          <div class="bg-white p-10 rounded-lg shadow-xl transition transform hover:scale-105">
            <div class="aspect-w-2 aspect-h-3">
            ...
            <h3 class="text-2xl font-bold text-black mb-5">Coloración</h3>
            <p class="text-lg text-gray-700">Desde tintes completos hasta mechas, nuestras peluqueras son expertas en coloración y te ayudarán a encontrar el tono perfecto para tu cabello.</p>
          </div>
          <div class="bg-white p-10 rounded-lg shadow-xl transition transform hover:scale-105">
            <div class="aspect-w-2 aspect-h-3">
            ...
            <h3 class="text-2xl font-bold text-black mb-5">Peinados</h3>
            <p class="text-lg text-gray-700">Para ocasiones especiales o para el día a día, nuestras estilistas crean peinados únicos y personalizados que te harán sentir fabulosa.</p>
          </div>
          <div class="bg-white p-10 rounded-lg shadow-xl transition transform hover:scale-105">
            <div class="aspect-w-2 aspect-h-3">
            ...
            <h3 class="text-2xl font-bold text-black mb-5">Peinados para Novias</h3>
            <p class="text-lg text-gray-700">Ofrecemos una variedad de estilos de peinados para novias, diseñados para complementar tu belleza en tu día especial.</p>
          </div>
          <div class="bg-white p-10 rounded-lg shadow-xl transition transform hover:scale-105">
            <div class="aspect-w-2 aspect-h-3">
            ...
            <h3 class="text-2xl font-bold text-black mb-5">Tratamientos Capilares</h3>
            <p class="text-lg text-gray-700">Nuestros tratamientos capilares están diseñados para nutrir y revitalizar tu cabello, dejándolo saludable y brillante.</p>
          </div>
          <div class="bg-white p-10 rounded-lg shadow-xl transition transform hover:scale-105">
            <div class="aspect-w-2 aspect-h-3">
            ...
            <h3 class="text-2xl font-bold text-black mb-5">Maquillaje</h3>
            <p class="text-lg text-gray-700">Ya sea para un evento especial, una sesión de fotos o simplemente porque sí, nuestras expertas en maquillaje te ayudarán a lograr el look perfecto.</p>
          </div>
        </div>
      </div>
    </section>
